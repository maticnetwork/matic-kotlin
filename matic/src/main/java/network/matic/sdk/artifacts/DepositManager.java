package network.matic.sdk.artifacts;
...
import network.matic.sdk.abi.datatypes.Bool;
...
import network.matic.sdk.abi.datatypes.generated.Bytes1;
import network.matic.sdk.abi.datatypes.generated.Bytes32;
import network.matic.sdk.abi.datatypes.generated.Uint256;
...
import network.matic.sdk.core.protocol.core.methods.request.EthFilter;
...
import network.matic.sdk.tuples.generated.Tuple5;

/**
 * <p>Auto generated code.
 * <p><strong>Do not modify!</strong>
 * <p>Please use the <a href="https://docs.web3j.io/command_line.html">web3j command line tools</a>,
 * or the network.matic.matick.codegen.SolidityFunctionWrapperGenerator in the
...
public class DepositManager extends Contract {
    ...
    public RemoteCall<byte[]> roundType() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_ROUNDTYPE,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<BigInteger> depositCount() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_DEPOSITCOUNT,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<String> reverseTokens(String param0) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_REVERSETOKENS,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(param0)),
    ...
    public RemoteCall<String> wethToken() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_WETHTOKEN,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
                }));
        return executeRemoteCallSingleValueReturn(function, String.class);
    ...
    public RemoteCall<TransactionReceipt> renounceOwnership() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
    ...
    public RemoteCall<byte[]> voteType() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_VOTETYPE,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<String> owner() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_OWNER,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
                }));
        return executeRemoteCallSingleValueReturn(function, String.class);
    ...
    public RemoteCall<Boolean> isOwner() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_ISOWNER,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<byte[]> networkId() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_NETWORKID,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<String> rootChain() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_ROOTCHAIN,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
                }));
        return executeRemoteCallSingleValueReturn(function, String.class);
    ...
    public RemoteCall<BigInteger> CHILD_BLOCK_INTERVAL() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_CHILD_BLOCK_INTERVAL,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
                }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    ...
    public RemoteCall<Tuple5<BigInteger, String, String, BigInteger, BigInteger>> deposits(BigInteger param0) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_DEPOSITS,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.generated.Uint256(param0)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
    ...
    public RemoteCall<byte[]> chain() {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_CHAIN,
                Arrays.<Type>asList(),
                Arrays.<TypeReference<?>>asList(new TypeReference<Bytes32>() {
                }));
        return executeRemoteCallSingleValueReturn(function, byte[].class);
    ...
    public RemoteCall<Boolean> isERC721(String param0) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_ISERC721,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(param0)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {
                }));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    ...
    public RemoteCall<String> tokens(String param0) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_TOKENS,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(param0)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
                }));
        return executeRemoteCallSingleValueReturn(function, String.class);
    ...
    public RemoteCall<TransactionReceipt> changeRootChain(String newRootChain) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(newRootChain)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> transferOwnership(String newOwner) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(newOwner)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setExitNFTContract(String _nftContract) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(_nftContract)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setWETHToken(String _token) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                FUNC_SETWETHTOKEN,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(_token)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> mapToken(String _rootToken, String _childToken, Boolean _isERC721) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                FUNC_MAPTOKEN,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.Address(_rootToken),
                        new network.matic.sdk.abi.datatypes.Address(_childToken),
                        new network.matic.sdk.abi.datatypes.Bool(_isERC721)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> finalizeCommit(BigInteger _currentHeaderBlock) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                FUNC_FINALIZECOMMIT,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.generated.Uint256(_currentHeaderBlock)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<BigInteger> nextDepositBlock(BigInteger currentHeaderBlock) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_NEXTDEPOSITBLOCK,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.generated.Uint256(currentHeaderBlock)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
                }));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<Tuple5<BigInteger, String, String, BigInteger, BigInteger>> depositBlock(BigInteger _depositCount) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(FUNC_DEPOSITBLOCK,
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.generated.Uint256(_depositCount)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
                }, new TypeReference<Address>() {
                }, new TypeReference<Address>() {
                }, new TypeReference<Uint256>() {
    ...
    public RemoteCall<TransactionReceipt> createDepositBlock(BigInteger _currentHeaderBlock, String _token, String _user, BigInteger _amountOrTokenId) {
        final network.matic.sdk.abi.datatypes.Function function = new network.matic.sdk.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.sdk.abi.datatypes.generated.Uint256(_currentHeaderBlock),
                        new network.matic.sdk.abi.datatypes.Address(_token),
                        new network.matic.sdk.abi.datatypes.Address(_user),
                        new network.matic.sdk.abi.datatypes.generated.Uint256(_amountOrTokenId)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
