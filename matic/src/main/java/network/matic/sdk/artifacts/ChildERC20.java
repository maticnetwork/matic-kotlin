...
import network.matic.sdk.abi.datatypes.generated.Uint8;
...
import network.matic.sdk.core.protocol.core.methods.response.BaseEventResponse;
...
public class ChildERC20 extends Contract {
    ...
    public static final Event LOGTRANSFER_EVENT = new Event("LogTransfer",
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}, new TypeReference<Uint256>() {}));
    ;
    ...
    public Single<RawTransaction> approve(String spender, BigInteger value) {
    ...
    public Single<RawTransaction> increaseAllowance(String spender, BigInteger addedValue) {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<String> parent() {
    ...
    public RemoteFunctionCall<String> parentOwner() {
    ...
    public Single<RawTransaction> decreaseAllowance(String spender, BigInteger subtractedValue) {
        final Function function = new Function(
    ...
    public RemoteFunctionCall<Boolean> disabledHashes(byte[] param0) {
    ...
    public RemoteFunctionCall<byte[]> getTransferTypedHash(BigInteger amount, byte[] data, String spender) {
    ...
    public Single<RawTransaction> setParent(String _parent) {
        final Function function = new Function(
                FUNC_SETPARENT,
    ...
    public Single<RawTransaction> deposit(String user, BigInteger amount) {
        final Function function = new Function(
                FUNC_DEPOSIT,
    ...
    public Single<RawTransaction> withdraw(BigInteger amount) {
        final Function function = new Function(
                FUNC_WITHDRAW,
                Arrays.<Type>asList(new Uint256(amount)),
                Collections.<TypeReference<?>>emptyList());
    ...
    public Single<RawTransaction> transferWithSig(byte[] sig, BigInteger amount, byte[] data, String to) {
        final Function function = new Function(
    ...
    public Single<RawTransaction> transferFrom(String from, String to, BigInteger value) {
        final Function function = new Function(
                FUNC_TRANSFERFROM,
