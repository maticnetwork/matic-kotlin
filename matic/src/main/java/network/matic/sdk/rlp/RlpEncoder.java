package network.matic.sdk.rlp;

import java.util.Arrays;
import java.util.List;

import static network.matic.sdk.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static network.matic.sdk.rlp.RlpDecoder.OFFSET_SHORT_STRING;
