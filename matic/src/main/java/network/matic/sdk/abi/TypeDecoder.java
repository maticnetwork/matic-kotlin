...
import network.matic.sdk.abi.datatypes.Array;
import network.matic.sdk.abi.datatypes.Bool;
import network.matic.sdk.abi.datatypes.Bytes;
import network.matic.sdk.abi.datatypes.DynamicArray;
import network.matic.sdk.abi.datatypes.DynamicBytes;
import network.matic.sdk.abi.datatypes.Fixed;
import network.matic.sdk.abi.datatypes.FixedPointType;
import network.matic.sdk.abi.datatypes.Int;
import network.matic.sdk.abi.datatypes.IntType;
import network.matic.sdk.abi.datatypes.NumericType;
...
import network.matic.sdk.abi.datatypes.generated.Uint160;
import network.matic.sdk.compat.BiFunction;
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>) Class.forName(
                            "network.matic.sdk.abi.datatypes.generated.StaticArray" + length);
