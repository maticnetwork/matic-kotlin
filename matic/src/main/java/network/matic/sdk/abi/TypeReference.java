 ...
 * Typed {@link network.matic.sdk.abi.datatypes.Array} types.
 *
...
public abstract class TypeReference<T extends network.matic.sdk.abi.datatypes.Type>
    ...
    public static <T extends network.matic.sdk.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends network.matic.sdk.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends network.matic.sdk.abi.datatypes.Type> getAtomicTypeClass(
...
//            return AbiTypes.getType(solidityType, primitives);
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends network.matic.sdk.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends network.matic.sdk.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "network.matic.sdk.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
    ...
    public abstract static class StaticArrayTypeReference<T extends network.matic.sdk.abi.datatypes.Type>
