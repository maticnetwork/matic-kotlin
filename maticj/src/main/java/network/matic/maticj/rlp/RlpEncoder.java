package network.matic.maticj.rlp;

import java.util.Arrays;
import java.util.List;

import static network.matic.maticj.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static network.matic.maticj.rlp.RlpDecoder.OFFSET_SHORT_STRING;
