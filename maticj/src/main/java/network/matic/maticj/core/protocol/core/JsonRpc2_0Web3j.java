...
import network.matic.maticj.core.protocol.core.methods.response.EthSubscribe;
...
import network.matic.maticj.core.protocol.rx.JsonRpc2_0Rx;
import network.matic.maticj.core.protocol.websocket.events.LogNotification;
import network.matic.maticj.core.protocol.websocket.events.NewHeadsNotification;
...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, network.matic.maticj.core.protocol.core.methods.response.EthSendTransaction>
    ethSendTransaction(Transaction transaction) {
        return new Request<>(
                "eth_sendTransaction",
                Arrays.asList(transaction),
                web3jService,
                network.matic.maticj.core.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, network.matic.maticj.core.protocol.core.methods.response.EthCall> ethCall(
            Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
                Arrays.asList(transaction, defaultBlockParameter),
                web3jService,
                network.matic.maticj.core.protocol.core.methods.response.EthCall.class);
    }
    ...
    public Request<?, ShhPost> shhPost(ShhPost shhPost) {
        return new Request<>(
                ...
                web3jService,
                network.matic.maticj.core.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Flowable<network.matic.maticj.core.protocol.core.methods.response.Transaction> transactionFlowable() {
        return web3jRx.transactionFlowable(blockTime);
    }

    @Override
    public Flowable<network.matic.maticj.core.protocol.core.methods.response.Transaction>
