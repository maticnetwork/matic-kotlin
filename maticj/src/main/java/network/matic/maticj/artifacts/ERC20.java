...
public class ERC20 extends Contract {
    ...
    public RemoteCall<BigInteger> totalSupply() {
        final network.matic.maticj.abi.datatypes.Function function = new network.matic.maticj.abi.datatypes.Function(FUNC_TOTALSUPPLY,
                Arrays.<Type>asList(),
    ...
    public RemoteCall<BigInteger> allowance(String owner, String spender) {
        final network.matic.maticj.abi.datatypes.Function function = new network.matic.maticj.abi.datatypes.Function(FUNC_ALLOWANCE,
                Arrays.<Type>asList(new network.matic.maticj.abi.datatypes.Address(owner),
