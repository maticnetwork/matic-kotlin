 ...
 */
package network.matic.maticj.abi;
...
import network.matic.maticj.abi.datatypes.DynamicArray;
 ...
 * Typed {@link network.matic.maticj.abi.datatypes.Array} types.
 *
...
public abstract class TypeReference<T extends network.matic.maticj.abi.datatypes.Type>
    ...
    public static <T extends network.matic.maticj.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends network.matic.maticj.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends network.matic.maticj.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends network.matic.maticj.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends network.matic.maticj.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends network.matic.maticj.abi.datatypes.Type> baseClass =
