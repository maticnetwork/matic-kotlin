...
import network.matic.maticj.abi.datatypes.Array;
import network.matic.maticj.abi.datatypes.Bool;
import network.matic.maticj.abi.datatypes.Bytes;
import network.matic.maticj.abi.datatypes.DynamicArray;
import network.matic.maticj.abi.datatypes.DynamicBytes;
import network.matic.maticj.abi.datatypes.Fixed;
import network.matic.maticj.abi.datatypes.FixedPointType;
import network.matic.maticj.abi.datatypes.Int;
import network.matic.maticj.abi.datatypes.IntType;
import network.matic.maticj.abi.datatypes.NumericType;
import network.matic.maticj.abi.datatypes.StaticArray;
import network.matic.maticj.abi.datatypes.Type;
import network.matic.maticj.abi.datatypes.Ufixed;
import network.matic.maticj.abi.datatypes.Uint;
import network.matic.maticj.abi.datatypes.Utf8String;
import network.matic.maticj.abi.datatypes.generated.Uint160;
import network.matic.maticj.compat.BiFunction;
import network.matic.maticj.compat.Compat;
