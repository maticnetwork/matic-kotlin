...
import network.matic.sdk.abi.datatypes.generated.Bytes4;
...
public class ChildERC721 extends Contract {
    ...
    public Single<RawTransaction> approve(String to, BigInteger tokenId) {
    ...
    public Single<RawTransaction> safeTransferFrom(String from, String to, BigInteger tokenId) {
        final Function function = new Function(
    ...
    public Single<RawTransaction> setApprovalForAll(String to, Boolean approved) {
        final Function function = new Function(
    ...
    public Single<RawTransaction> safeTransferFrom(String from, String to, BigInteger tokenId, byte[] _data) {
        final Function function = new Function(
                FUNC_SAFETRANSFERFROM,
                Arrays.<Type>asList(new Address(from),
                        new Address(to),
    ...
    public Single<RawTransaction> deposit(String user, BigInteger tokenId) {
        final Function function = new Function(
                FUNC_DEPOSIT,
    ...
    public Single<RawTransaction> withdraw(BigInteger tokenId) {
        final Function function = new Function(
                FUNC_WITHDRAW,
                Arrays.<Type>asList(new Uint256(tokenId)),
                Collections.<TypeReference<?>>emptyList());
    ...
    public Single<RawTransaction> transferWithSig(byte[] sig, BigInteger tokenId, byte[] data, String to) {
        final Function function = new Function(
    ...
    public Single<RawTransaction> safeTransferWithSig(byte[] sig, BigInteger tokenId, byte[] data, String to) {
        final Function function = new Function(
    ...
    public Single<RawTransaction> transferFrom(String from, String to, BigInteger tokenId) {
        final Function function = new Function(
                FUNC_TRANSFERFROM,
                Arrays.<Type>asList(new Address(from),
                        new Address(to),
