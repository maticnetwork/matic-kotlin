...
public class ERC721 extends Contract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceId) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(FUNC_SUPPORTSINTERFACE,
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.generated.Bytes4(interfaceId)),
    ...
    public RemoteCall<String> ownerOf(BigInteger tokenId) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(FUNC_OWNEROF,
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.generated.Uint256(tokenId)),
    ...
    public RemoteCall<TransactionReceipt> approve(String to, BigInteger tokenId) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.Address(to),
                        new network.matic.matick.abi.datatypes.generated.Uint256(tokenId)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<String> getApproved(BigInteger tokenId) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(FUNC_GETAPPROVED,
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.generated.Uint256(tokenId)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
                }));
        return executeRemoteCallSingleValueReturn(function, String.class);
    ...
    public RemoteCall<TransactionReceipt> setApprovalForAll(String to, Boolean approved) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.Address(to),
                        new network.matic.matick.abi.datatypes.Bool(approved)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<Boolean> isApprovedForAll(String owner, String operator) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(FUNC_ISAPPROVEDFORALL,
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.Address(owner),
                        new network.matic.matick.abi.datatypes.Address(operator)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {
                }));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    }
    ...
    public RemoteCall<TransactionReceipt> safeTransferFrom(String from, String to, BigInteger tokenId, byte[] _data) {
        final network.matic.matick.abi.datatypes.Function function = new network.matic.matick.abi.datatypes.Function(
                ...
                Arrays.<Type>asList(new network.matic.matick.abi.datatypes.Address(from),
                        new network.matic.matick.abi.datatypes.Address(to),
                        new network.matic.matick.abi.datatypes.generated.Uint256(tokenId),
                        new network.matic.matick.abi.datatypes.DynamicBytes(_data)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
