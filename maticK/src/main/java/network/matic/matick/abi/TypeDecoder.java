...
import network.matic.matick.abi.datatypes.Array;
import network.matic.matick.abi.datatypes.Bool;
import network.matic.matick.abi.datatypes.Bytes;
import network.matic.matick.abi.datatypes.DynamicArray;
import network.matic.matick.abi.datatypes.DynamicBytes;
import network.matic.matick.abi.datatypes.Fixed;
import network.matic.matick.abi.datatypes.FixedPointType;
import network.matic.matick.abi.datatypes.Int;
import network.matic.matick.abi.datatypes.IntType;
import network.matic.matick.abi.datatypes.NumericType;
import network.matic.matick.abi.datatypes.StaticArray;
import network.matic.matick.abi.datatypes.Type;
import network.matic.matick.abi.datatypes.Ufixed;
import network.matic.matick.abi.datatypes.Uint;
import network.matic.matick.abi.datatypes.Utf8String;
import network.matic.matick.abi.datatypes.generated.Uint160;
import network.matic.matick.compat.BiFunction;
