 ...
 */
package network.matic.matick.abi;
 ...
 * Typed {@link network.matic.matick.abi.datatypes.Array} types.
 *
...
public abstract class TypeReference<T extends network.matic.matick.abi.datatypes.Type>
    ...
    public static <T extends network.matic.matick.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends network.matic.matick.abi.datatypes.Type> getAtomicTypeClass(
...
//            return AbiTypes.getType(solidityType, primitives);
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends network.matic.matick.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends network.matic.matick.abi.datatypes.Type> baseClass =
