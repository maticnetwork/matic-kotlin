...
import network.matic.matick.abi.datatypes.BytesType;
...
import static network.matic.matick.abi.datatypes.Type.MAX_BIT_LENGTH;
import static network.matic.matick.abi.datatypes.Type.MAX_BYTE_LENGTH;
