...
import network.matic.matick.core.protocol.core.methods.request.ShhFilter;
import network.matic.matick.core.protocol.core.methods.request.Transaction;
import network.matic.matick.core.protocol.core.methods.response.DbGetHex;
import network.matic.matick.core.protocol.core.methods.response.DbGetString;
import network.matic.matick.core.protocol.core.methods.response.DbPutHex;
import network.matic.matick.core.protocol.core.methods.response.DbPutString;
import network.matic.matick.core.protocol.core.methods.response.EthAccounts;
import network.matic.matick.core.protocol.core.methods.response.EthBlock;
import network.matic.matick.core.protocol.core.methods.response.EthBlockNumber;
import network.matic.matick.core.protocol.core.methods.response.EthCoinbase;
import network.matic.matick.core.protocol.core.methods.response.EthCompileLLL;
import network.matic.matick.core.protocol.core.methods.response.EthCompileSerpent;
import network.matic.matick.core.protocol.core.methods.response.EthCompileSolidity;
...
import network.matic.matick.core.protocol.core.methods.response.EthGetBlockTransactionCountByHash;
import network.matic.matick.core.protocol.core.methods.response.EthGetBlockTransactionCountByNumber;
import network.matic.matick.core.protocol.core.methods.response.EthGetCode;
import network.matic.matick.core.protocol.core.methods.response.EthGetCompilers;
import network.matic.matick.core.protocol.core.methods.response.EthGetStorageAt;
...
import network.matic.matick.core.protocol.core.methods.response.EthGetUncleCountByBlockHash;
import network.matic.matick.core.protocol.core.methods.response.EthGetUncleCountByBlockNumber;
import network.matic.matick.core.protocol.core.methods.response.EthGetWork;
import network.matic.matick.core.protocol.core.methods.response.EthHashrate;
import network.matic.matick.core.protocol.core.methods.response.EthLog;
import network.matic.matick.core.protocol.core.methods.response.EthMining;
import network.matic.matick.core.protocol.core.methods.response.EthProtocolVersion;
import network.matic.matick.core.protocol.core.methods.response.EthSign;
import network.matic.matick.core.protocol.core.methods.response.EthSubmitHashrate;
import network.matic.matick.core.protocol.core.methods.response.EthSubmitWork;
import network.matic.matick.core.protocol.core.methods.response.EthSubscribe;
import network.matic.matick.core.protocol.core.methods.response.EthSyncing;
import network.matic.matick.core.protocol.core.methods.response.EthTransaction;
import network.matic.matick.core.protocol.core.methods.response.EthUninstallFilter;
import network.matic.matick.core.protocol.core.methods.response.Log;
import network.matic.matick.core.protocol.core.methods.response.NetListening;
import network.matic.matick.core.protocol.core.methods.response.NetPeerCount;
import network.matic.matick.core.protocol.core.methods.response.NetVersion;
import network.matic.matick.core.protocol.core.methods.response.ShhAddToGroup;
import network.matic.matick.core.protocol.core.methods.response.ShhHasIdentity;
import network.matic.matick.core.protocol.core.methods.response.ShhMessages;
import network.matic.matick.core.protocol.core.methods.response.ShhNewFilter;
import network.matic.matick.core.protocol.core.methods.response.ShhNewGroup;
import network.matic.matick.core.protocol.core.methods.response.ShhNewIdentity;
import network.matic.matick.core.protocol.core.methods.response.ShhPost;
import network.matic.matick.core.protocol.core.methods.response.ShhUninstallFilter;
import network.matic.matick.core.protocol.core.methods.response.ShhVersion;
import network.matic.matick.core.protocol.core.methods.response.Web3ClientVersion;
import network.matic.matick.core.protocol.core.methods.response.Web3Sha3;
import network.matic.matick.core.protocol.rx.JsonRpc2_0Rx;
import network.matic.matick.core.protocol.websocket.events.LogNotification;
import network.matic.matick.core.protocol.websocket.events.NewHeadsNotification;
...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, network.matic.matick.core.protocol.core.methods.response.EthSendTransaction>
    ethSendTransaction(Transaction transaction) {
        return new Request<>(
                "eth_sendTransaction",
                Arrays.asList(transaction),
                web3jService,
                network.matic.matick.core.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, network.matic.matick.core.protocol.core.methods.response.EthCall> ethCall(
            Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
                Arrays.asList(transaction, defaultBlockParameter),
                web3jService,
                network.matic.matick.core.protocol.core.methods.response.EthCall.class);
    }
    ...
    @Override
    public Request<?, EthFilter> ethNewFilter(network.matic.matick.core.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
    ...
    @Override
    public Request<?, ShhPost> shhPost(ShhPost shhPost) {
        return new Request<>(
                "shh_post",
                Arrays.asList(shhPost),
                web3jService,
                network.matic.matick.core.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Flowable<Log> ethLogFlowable(network.matic.matick.core.protocol.core.methods.request.EthFilter ethFilter) {
        return web3jRx.ethLogFlowable(ethFilter, blockTime);
    }

    @Override
    public Flowable<network.matic.matick.core.protocol.core.methods.response.Transaction> transactionFlowable() {
        return web3jRx.transactionFlowable(blockTime);
    }

    @Override
    public Flowable<network.matic.matick.core.protocol.core.methods.response.Transaction>
