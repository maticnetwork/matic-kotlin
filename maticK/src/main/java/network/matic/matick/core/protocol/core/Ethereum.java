...
import network.matic.matick.core.protocol.core.methods.response.EthCall;
...
public interface Ethereum {
    ...
    Request<?, EthFilter> ethNewFilter(network.matic.matick.core.protocol.core.methods.request.EthFilter ethFilter);
