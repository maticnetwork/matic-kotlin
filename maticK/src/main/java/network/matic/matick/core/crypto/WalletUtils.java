package network.matic.matick.core.crypto;
...
import network.matic.matick.crypto.Bip39Wallet;
import network.matic.matick.crypto.CipherException;
import network.matic.matick.crypto.Credentials;
import network.matic.matick.crypto.ECKeyPair;
import network.matic.matick.crypto.Keys;
import network.matic.matick.crypto.MnemonicUtils;
import network.matic.matick.crypto.SecureRandomUtils;
import network.matic.matick.utils.utils.Numeric;

import static network.matic.matick.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static network.matic.matick.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
import static network.matic.matick.utils.crypto.Hash.sha256;
