package network.matic.maticj.core.crypto;

import com.fasterxml.jackson.core.JsonParser;
import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;

import network.matic.maticj.crypto.Bip39Wallet;
import network.matic.maticj.crypto.CipherException;
import network.matic.maticj.crypto.Credentials;
import network.matic.maticj.crypto.ECKeyPair;
import network.matic.maticj.crypto.Keys;
import network.matic.maticj.crypto.MnemonicUtils;
import network.matic.maticj.crypto.SecureRandomUtils;
...
import static network.matic.maticj.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static network.matic.maticj.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
import static network.matic.maticj.utils.crypto.Hash.sha256;
